...
import { saveRoadmap, getRoadmapById } from '@/lib/storage';
...
export default function EditRoadmapPage() {
  ...
  useEffect(() => {
    ...
    const formSteps: StepFormData[] = roadmap.steps.map((step) => ({
      id: step.id,
      title: step.title,
      description: step.description || '',
      baseType: step.baseType,
      dayOffset: step.dayOffset,
      fixedMonth: step.fixedMonth || 1,
      fixedDay: step.fixedDay || 1,
      isRepeating: step.isRepeating || false,
      repeatInterval: step.repeatInterval || 7,
    }));
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    const roadmap: Roadmap = {
      ...
      steps: roadmapSteps,
      createdAt: originalRoadmap?.createdAt || new Date(),
      updatedAt: new Date(),
    };
